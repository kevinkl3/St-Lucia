...
<body>
  ...
  <nav id="sidebar-wrapper">
    <ul class="sidebar-nav accordion-menu" style="font-weight:bold;">
      <a id="menu-close" href="#" class="btn btn-light btn-lg pull-right" style="width:250px;"><i class="fa fa-times"></i></a>
      <li class="sidebar-brand">
        <a href="<?php echo $this->createUrl('/'); ?>" style="text-align:center;">SANTA LUCÍA</a>
      </li>
      <?php if ($this->HOME): ?>
      <li>
  ...
  <li class="dropdown">
    ...
    <ul class="collapsable-menu" role="menu">
      ...
      <li>
        <a class="font-uc sub-section" href="<?php echo $this->createUrl('site/posts', array('seccion' => $s->getUrlName())); ?>"><?php echo $s->NAME; ?></a>
      </li>
    <?php endforeach; ?>
  </ul>
</li>
<?php endif; ?>
<li class="sidebar-brand">
  <a href="<?php echo $this->createUrl('/'); ?>" class="navbar-brand">
    <img class="st-logo" src="<?php echo Yii::app()->baseUrl; ?>/images/st-logo.png"/>
  </a>
</li>
</ul>
</nav>
