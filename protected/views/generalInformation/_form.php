...
<div class="well">
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <?php echo $form->labelEx($model, 'MISSION', array('class' => 'col-lg-2 control-label')); ?>
            <div class="col-lg-10">
                <?php echo $form->textArea($model, 'MISSION', array('rows' => 2, 'cols' => 50, 'class' => 'form-control')); ?>
            </div>
            <?php echo $form->error($model, 'MISSION'); ?>
        </div>

        <div class="form-group">
            <?php echo $form->labelEx($model, 'VISION', array('class' => 'col-lg-2 control-label')); ?>
            <div class="col-lg-10">
                <?php echo $form->textArea($model, 'VISION', array('rows' => 2, 'cols' => 50, 'class' => 'form-control')); ?>
            </div>
